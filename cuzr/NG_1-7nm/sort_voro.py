...
def voro_plot_sort(name,m1,m2,m3,m4,m5,l1,l2,l3,l4,l5,species,cs,typ):
    h1 = m1.h
    h2 = m2.h
    h3 = m3.h
    h4 = m4.h
    ...
    yl = (max(h1[3], h2[3], h3[3], h4[3], h5[3])) * 1.05
    ylmin = (min(h1[3], h2[3], h3[3], h4[3], h5[3])) * 0.97
    yl3 = (max(h1[2], h2[2], h3[2], h4[2], h5[2])) * 1.10
    yl2 = (max(h1[0], h2[0], h3[0], h4[0], h5[0])) * 1.05
    yl2min = (min(h1[0], h2[0], h3[0], h4[0], h5[0])) * 0.95
...
def plot_atmhisto_nico(name,m1,m2,m3,m4,m5,l1,l2,l3,l4,l5,species,cs,typ):
    h1,n1 = m1.v,m1.d
    h2,n2 = m2.v,m2.d
    h3,n3 = m3.v,m3.d
    h4,n4 = m4.v,m4.d
