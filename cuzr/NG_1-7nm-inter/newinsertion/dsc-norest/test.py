...
src = '/home/mj0054/Documents/work/simulations/projects/nanoglass/50-50/1e10/segregated/random/5GPa/newinsertion/dsc/norest/'
# fn = 'log.file'
...
print(data)
enthalpies = pd.DataFrame(data, columns=cols)
print(enthalpies)
