...
def ovito_strain(name, pipeline, fil, typ, case):
  ...
  file='/home/mj0054/Documents/work/simulations/projects/nanoglass/50-50/1e10/segregated/random/'+name.split(' ')[-1]+'/refconfig_'+case+'.txt'
  ...
  with open(fil3, 'a') as f:
    # for row in rows:
    rows2 = case+','+str(sum(strain)/len(strain))
    f.write(rows2)
    f.write('\n')
  return []
