...
def reassemble(h1, b1, h2, b2, h3, b3):  # rearrange all b entries
  un1 = union(b1, b2)
  un2 = union(b3, un1)
  in1 = inter(b1, b2)
  in2 = inter(b3, in1)

  ncdf = [x for x in un2 if x not in in2]
  ...
  return [H1, b, H2, b, H3, b];


def collate_ico(name, o1, o2, o3, p1, p2, p3, l1, l2, l3, cs, typ):
  if typ == 1:
    comm = 'As Prepared'
    tag = 'asp'
  elif typ == 2:
  ...
  i_ico = "<0 0 12 0>"
  a1 = [o1.a[o1.b.index(i_ico)], o2.a[o2.b.index(i_ico)], o3.a[o3.b.index(i_ico)]]
  a2 = [p1.a[o1.b.index(i_ico)], p2.a[o2.b.index(i_ico)], p3.a[o3.b.index(i_ico)]]
  a3 = [l1, l2, l3]
  ...
  b1 = [o1.h[0], o2.h[0], o3.h[0]]
  b2 = [p1.h[0], o2.h[0], p3.h[0]]
  rows2 = zip(b1, b2, a3)
  ...
  c1 = [sum(o1.h[1:]), sum(o2.h[1:]), sum(o3.h[1:])]
  c2 = [sum(p1.h[1:]), sum(p2.h[1:]), sum(p3.h[1:])]
  rows3 = zip(c1, c2, a3)
